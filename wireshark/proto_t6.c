...
static int handle_bulk(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, proto_tree *parent_tree, usb_conv_info_t *usb_conv_info) {
...
static int dissect_t6(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data) {
    ...
    switch (usb_conv_info->endpoint) {
        ...
        case 1:
        case 2:
            return handle_bulk(tvb, pinfo, t6_tree, tree, usb_conv_info);
        case 3:
